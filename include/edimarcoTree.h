...
// Sat May 16 22:56:05 2015 by ROOT version 5.34/23
// from TTree tree/treeProducerDarkMatterMonoJet
// found on file: tree.root
//////////////////////////////////////////////////////////

#ifndef edimarcoTree_h
#define edimarcoTree_h
...
public :
   ...
   // Declaration of variables in Friend Tree
   Float_t         nMu10V;
   Float_t         nMu20T;
   Float_t         nEle10V;
   Float_t         nEle20T;
   ...
   Int_t           nGenPart;
   Int_t           GenPart_motherId[16];   //[nGenPart]
   Int_t           GenPart_grandmotherId[16];   //[nGenPart]
   Int_t           GenPart_sourceId[16];   //[nGenPart]
   Float_t         GenPart_charge[16];   //[nGenPart]
   Int_t           GenPart_status[16];   //[nGenPart]
   Int_t           GenPart_pdgId[16];   //[nGenPart]
   Float_t         GenPart_pt[16];   //[nGenPart]
   Float_t         GenPart_eta[16];   //[nGenPart]
   Float_t         GenPart_phi[16];   //[nGenPart]
   Float_t         GenPart_mass[16];   //[nGenPart]
   Int_t           GenPart_motherIndex[16];   //[nGenPart]
   Int_t           nisoTrack;
   ...
   Int_t           nLepGood;
   Int_t           LepGood_eleMVAId[4];   //[nLepGood]
   Float_t         LepGood_mvaId[4];   //[nLepGood]
   Float_t         LepGood_mvaIdTrig[4];   //[nLepGood]
   Float_t         LepGood_mvaIdPhys14[4];   //[nLepGood]
   Float_t         LepGood_mvaTTH[4];   //[nLepGood]
   Float_t         LepGood_mvaSusy[4];   //[nLepGood]
   Float_t         LepGood_jetPtRatio[4];   //[nLepGood]
   Float_t         LepGood_jetPtRel[4];   //[nLepGood]
   Float_t         LepGood_jetBTagCSV[4];   //[nLepGood]
   Float_t         LepGood_jetBTagCMVA[4];   //[nLepGood]
   Float_t         LepGood_jetDR[4];   //[nLepGood]
   ...
   Float_t         LepGood_miniRelIsoCharged[4];   //[nLepGood]
   Float_t         LepGood_miniRelIsoNeutral[4];   //[nLepGood]
   Int_t           LepGood_hasSV[4];   //[nLepGood]
   Float_t         LepGood_svRedPt[4];   //[nLepGood]
   Float_t         LepGood_svRedM[4];   //[nLepGood]
   Float_t         LepGood_svLepSip3d[4];   //[nLepGood]
   Float_t         LepGood_svSip3d[4];   //[nLepGood]
   Float_t         LepGood_svNTracks[4];   //[nLepGood]
   Float_t         LepGood_svChi2n[4];   //[nLepGood]
   Float_t         LepGood_svDxy[4];   //[nLepGood]
   Float_t         LepGood_svMass[4];   //[nLepGood]
   Float_t         LepGood_svPt[4];   //[nLepGood]
   Float_t         LepGood_svMCMatchFraction[4];   //[nLepGood]
   Float_t         LepGood_svMva[4];   //[nLepGood]
   Float_t         LepGood_jetNDau[4];   //[nLepGood]
   Float_t         LepGood_jetNDauCharged[4];   //[nLepGood]
   Float_t         LepGood_jetNDauPV[4];   //[nLepGood]
   Float_t         LepGood_jetNDauNotPV[4];   //[nLepGood]
   Float_t         LepGood_jetmaxSignedSip3D[4];   //[nLepGood]
   Float_t         LepGood_jetmaxSip3D[4];   //[nLepGood]
   Float_t         LepGood_jetmaxSignedSip2D[4];   //[nLepGood]
   Float_t         LepGood_jetmaxSip2D[4];   //[nLepGood]
   Float_t         LepGood_jetPtRelv0[4];   //[nLepGood]
   Float_t         LepGood_jetMass[4];   //[nLepGood]
   Float_t         LepGood_jetPrunedMass[4];   //[nLepGood]
   Float_t         LepGood_jetDecDR[4];   //[nLepGood]
   Float_t         LepGood_jetDecPtRel[4];   //[nLepGood]
   Float_t         LepGood_jetDecPtRatio[4];   //[nLepGood]
   Float_t         LepGood_jetDecPrunedMass[4];   //[nLepGood]
   Float_t         LepGood_jetDecPrunedPtRatio[4];   //[nLepGood]
   Float_t         LepGood_jetDec02DR[4];   //[nLepGood]
   Float_t         LepGood_jetDec02PtRel[4];   //[nLepGood]
   Float_t         LepGood_jetDec02PtRatio[4];   //[nLepGood]
   Float_t         LepGood_jetDec02PrunedPtRatio[4];   //[nLepGood]
   Float_t         LepGood_jetDec02PrunedMass[4];   //[nLepGood]
   Int_t           ngenJet;
   ...
   // list of branches in Friend Tree
   TBranch        *b_nMu10V;   //!
   TBranch        *b_nMu20T;   //!
   TBranch        *b_nEle10V;   //!
   TBranch        *b_nEle20T;   //!
   ...
   edimarcoTree(TTree *tree=0);
   virtual ~edimarcoTree();
...
#ifdef edimarcoTree_cxx
edimarcoTree::edimarcoTree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   ...
   //std::cout<<"check inside constructor"<<std::endl;
   Init(tree);
}

edimarcoTree::~edimarcoTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t edimarcoTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t edimarcoTree::LoadTree(Long64_t entry)
{
...
void edimarcoTree::Init(TTree *tree)
{
   ...
   //std::cout<<"check inside Init()"<<std::endl;
...
void edimarcoTree::Show(Long64_t entry)
{
...
Int_t edimarcoTree::Cut(Long64_t entry)
{
