...
// Mon Jun 29 12:26:50 2015 by ROOT version 5.34/18
// from TTree tree/treeProducerDarkMatterMonoJet
// found on file: tree.root
//////////////////////////////////////////////////////////

#ifndef edimarcoTree_noSkim_h
#define edimarcoTree_noSkim_h
...
public :
   ...
   Int_t           nFatJet;
   Int_t           FatJet_id[9];   //[nFatJet]
   Int_t           FatJet_puId[9];   //[nFatJet]
   ...
   Int_t           FatJet_mcMatchId[9];   //[nFatJet]
   ...
   Float_t         FatJet_filteredMass[9];   //[nFatJet]
   Float_t         FatJet_tau1[9];   //[nFatJet]
   Float_t         FatJet_tau2[9];   //[nFatJet]
   Float_t         FatJet_tau3[9];   //[nFatJet]
   Float_t         FatJet_topMass[9];   //[nFatJet]
   Float_t         FatJet_minMass[9];   //[nFatJet]
   Float_t         FatJet_nSubJets[9];   //[nFatJet]
   Int_t           nGenPart;
   Int_t           GenPart_motherId[18];   //[nGenPart]
   Int_t           GenPart_grandmotherId[18];   //[nGenPart]
   Int_t           GenPart_sourceId[18];   //[nGenPart]
   Float_t         GenPart_charge[18];   //[nGenPart]
   Int_t           GenPart_status[18];   //[nGenPart]
   Int_t           GenPart_pdgId[18];   //[nGenPart]
   Float_t         GenPart_pt[18];   //[nGenPart]
   Float_t         GenPart_eta[18];   //[nGenPart]
   Float_t         GenPart_phi[18];   //[nGenPart]
   Float_t         GenPart_mass[18];   //[nGenPart]
   Int_t           GenPart_motherIndex[18];   //[nGenPart]
   Int_t           nisoTrack;
   ...
   edimarcoTree_noSkim(TTree *tree=0);
   virtual ~edimarcoTree_noSkim();
...
#ifdef edimarcoTree_noSkim_cxx
edimarcoTree_noSkim::edimarcoTree_noSkim(TTree *tree) : fChain(0) 
{
...
edimarcoTree_noSkim::~edimarcoTree_noSkim()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t edimarcoTree_noSkim::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t edimarcoTree_noSkim::LoadTree(Long64_t entry)
{
...
void edimarcoTree_noSkim::Init(TTree *tree)
{
...
Bool_t edimarcoTree_noSkim::Notify()
{
...
void edimarcoTree_noSkim::Show(Long64_t entry)
{
...
Int_t edimarcoTree_noSkim::Cut(Long64_t entry)
{
...
#endif // #ifdef edimarcoTree_noSkim_cxx
